...
extension DatabaseManager {
        ...
        ref.observeSingleEvent(of: .value, with: { [ weak self] snapshot in
            ...
            self?.database.child("\(otherUsersEmail)/conversations").observeSingleEvent(of: .value, with: { [weak self] snapshot in
                if var conversations = snapshot.value as? [[String: Any]] {
                    ...
                    self?.database.child("\(otherUsersEmail)/conversations").setValue(conversations)
                }
                else {
                    // creation
    ...
    public func deletConversation(conversationId: String, completion: @escaping (Bool) -> Void) {
        ...
        //get all convo for current user
        //delet convos with target id
        //reset thoes convos in database
    ...
    public func conersationExists(with targetRecipientEmail: String, completion: @escaping (Result<String, Error>) -> Void) {
